---
name: claude-worker
description: Invoke Claude Worker (Claude Code CLI wrapper) for independent code review, coding, and testing tasks. Use when Hermes needs an independent second opinion for high-risk reviews, architecture arbitration, or Class C/D validation.
version: 1.0.0
author: brantzh6
tags:
  - claude-worker
...
- worker.py deployed (default: `~/.hermes/skills/claude-worker/worker.py` or project-local)
...
- Do NOT make final architecture decisions (return results to Hermes for decision)
