---
name: sdlc-harness
description: AgentSDLC governance harness for Hermes agent. Injects SDLC lifecycle rules, task classification, Gate system, review discipline and completion evidence requirements. Use this skill when starting any non-trivial task.
version: 1.0.0
author: brantzh6
tags:
  - sdlc
...
# AgentSDLC Governance Harness — Hermes
...
- **You (Hermes) = controller + primary implementer** (code, test, review)
